...
resource "aws_db_instance" "wordpressdb" {
  ...
  name                   = var.db_name // removed reference to var file might need replicate in user and passwd
...
# Play ansible playbook
  provisioner "local-exec" {
     command = "ANSIBLE_HOST_KEY_CHECKING=False ansible-playbook -u ubuntu -i '${aws_eip.eip.public_ip},' --private-key ${var.PRIV_KEY_PATH}  playbook-rendered.yml"
